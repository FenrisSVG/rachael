	...
	<div class="quiz-template">
		<div class="quiz">
			...
			<div class="quiz-container" v-if="questions.length > 0">
				<h2 class="quiz-title">
					Test <span>Psicometrico</span> para <span>estudiantes</span>.
				</h2>
				<div class="quiz-container__test">
					<div class="quiz-container__show" v-if="index < count">
					...
					<div v-else class="quiz-results">
						<h2 class="quiz-results__title">
							Resultados del Test Psicometrico.
						</h2>
						<div class="quiz-results__answers">
							<p class="quiz-results__correct">
								Puntaje: {{ correctAnswer }}/{{ count }}
							</p>
							<p class="quiz-results__correct">
								Respuestas Correctas: <span>{{ correctAnswer }}</span>
							</p>
							<p class="quiz-results__incorrect">
								Respuestas Incorrectas: <span>{{ wrongAnswer }}</span>
							</p>
						</div>
					</div>
				</div>
	...
	data() {
		return {
			...
			questions: [
				{
					id: 1,
					question: "es a PLUMA como PEZ es a",
					answer: {
						a: "Aire - Mar",
						b: "Ave - Escama",
						c: "Ave - Mar",
				...
				{
					id: 6,
					question: "Indica el sinónimo de 'pedazo'",
