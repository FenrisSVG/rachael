            ...
            <form @submit.prevent="insertData" class="entrevista-form" autocomplete="off" id="entrevista">
                <div class="datos antecedentes-input--active" id="datos">
                    ...
                    <div class="datos-personales">
                        ...
                        <input class="datos-personales__input" type="checkbox" name="referencia">
                        <label for="urgente">Urgente</label>
                        <input class="datos-personales__input" type="checkbox" name="urgente">
                        <label for="no-urgente">No Urgente</label>
                    </div>
                    <div class="datos-personales">
                        <label for="expediente">Expediente</label>
                        <input class="datos-personales__input default" type="text" name="expediente" id="idpaciente">
                    </div>
                    <div class="datos-personales">
                        <label for="nombre">Nombre:</label>
                        <input class="datos-personales__input default" type="text" name="nombre" placeholder="Escriba su nombre..." required id="name">
                        <label for="surname" class="datos-personales__surname">Apellido:</label>
                        <input class="datos-personales__input default" type="text" name="surname" required placeholder="Escriba su apellido..." id="surname">
                    </div>
                    <div class="datos-personales">
                        <label for="fecha">Fecha:</label>
                        <input class="datos-personales__input default" type="text" name="fecha" id="fecha-antecedente">
                    </div>
                    <div class="datos-personales">
                        <p>Genero:</p>
                        <label for="masculino">Masculino</label>
                        <input class="datos-personales__input" type="checkbox" name="masculino" id="masculino">
                        <label for="femenino">Femenino</label>
                        <input class="datos-personales__input" type="checkbox" name="femenino" id="femenino">
                    </div>
                </div>
                <div class="datos" id="antecedentes-form">
                    ...
                    <div class="antecedentes-input">
                        ...
                        <div class="referencia">
                            ...
                            <input class="antecedentes-input__input" type="checkbox" name="alta">
                            <label for="alta">Alta</label>
                            <input class="antecedentes-input__input" type="checkbox" name="Moderada">
                            <label for="Moderada">Moderada</label>
                            <input class="antecedentes-input__input" type="checkbox" name="Baja">
                            <label for="alta">Baja</label>
                        </div>
                    </div>
                    <div class="antecedentes-input">
                        <h6>2. ¿Ha recibido un tratamiento psico-terapeutico con anterioridad?</h6>
                        <input class="antecedentes-input__input" type="checkbox" name="si" id="tratamiento">
                        <label for="si">Si</label>
                        <input class="antecedentes-input__input" type="checkbox" name="no" id="tratamiento-no">
                    ...
                    <div class="antecedentes-input">
                        ...
                        <div class="habitos">
                            ...
                            <input class="antecedentes-input__input" type="checkbox" name="sigue-dieta" id="dieta">
                            <label for="sigue-dieta">Sigue Dieta</label>
                            <input class="antecedentes-input__input" type="checkbox" name="Moderada" id="moderada">
                            <label for="moderada">Moderada</label>
                            <input class="antecedentes-input__input" type="checkbox" name="estricta" id="estricta">
                            <label for="estricta">Estricta</label>
                            <input class="antecedentes-input__input" type="checkbox" name="vegano" id="vegano">
                            <label for="Vegano">Vegano</label>
                        </div>
                        <div class="consumo">
                            <h6>b. Consumo</h6>
                            <input class="antecedentes-input__input" type="checkbox" name="Alcohol" id="alcohol">
                            <label for="Alcohol">Alcohol</label>
                            <input class="antecedentes-input__input" type="checkbox" name="te" id="te">
                            <label for="te">Te</label>
                            <input class="antecedentes-input__input" type="checkbox" name="Cafe" id="cafe">
                            <label for="Cafe">Cafe</label>
                        </div>
                        <div class="medicamente">
                            <h6>c. Medicamentos</h6>
                            <input class="antecedentes-input__input" type="checkbox" name="drogas" id="drogas">
                            <label for="drogas">Rechazo a Drogas</label>
                            <input class="antecedentes-input__input" type="checkbox" name="hipersensibilidad" id="hipersensibilidad">
                    ...
                    <div class="antecedentes-input">
                        ...
                        <div class="familiares">
                            ...
                            <input class="antecedentes-input__input" type="checkbox" name="bullying" id="bullying">
                            <label for="bullying">Sufria Bullying</label>
                            <input class="antecedentes-input__input" type="checkbox" name="muerte" id="muerte">
                            <label for="muerte">Muerte de Familiar</label>
                            <input class="antecedentes-input__input" type="checkbox" name="padres-separados" id="padres">
                            <label for="padres-separados">Padres Separados</label>
                            <input class="antecedentes-input__input" type="checkbox" name="ciudad" id="ciudad">
                            <label for="ciudad">Cambio de ciudad constante</label>
                        </div>
                        <div class="sexo">
                            <h6>b. Sexooooooooooooooo</h6>
                            <input class="antecedentes-input__input" type="checkbox" name="activo" id="activo">
                            <label for="activo">Activo</label>
                            <input class="antecedentes-input__input" type="checkbox" name="virgen" id="virgen">
                            <label for="virgen">Virgen</label>
                            <input class="antecedentes-input__input" type="checkbox" name="ocasional" id="ocasional">
                            <label for="ocasional">Ocasional</label>
                        </div>
                        <div class="familia">
                            <h6>c. Clasificas la relacion con tu familia como</h6>
                            <input class="antecedentes-input__input" type="checkbox" name="disfuncional" id="disfuncional">
                            <label for="disfuncional">Disfuncional</label>
                            <input class="antecedentes-input__input" type="checkbox" name="tranquila" id="tranquila">
                            <label for="tranquila">Tranquila</label>
                            <input class="antecedentes-input__input" type="checkbox" name="confianza" id="confianza">
                            <label for="confianza">De confianza</label>
                            <input class="antecedentes-input__input" type="checkbox" name="separados" id="separados">
                    ...
                    <div class="antecedentes-input">
                        ...
                        <div class="traumas">
                            ...
                            <label for="si">Si</label>
                            <input class="antecedentes-input__input" type="checkbox" name="si" id="traumas" v-on:change="showTraumas">
                            <label for="no">No</label>
                            <input class="antecedentes-input__input" type="checkbox" name="no" id="traumas-no" v-on:change="traumasChecked">
                        </div>
                        <div id="traumas-show" class="traumas-show">
                            <div class="traumas-familia">
                                <h6>b. ¿El suceso traumatico le ha ocurrido a un familiar?</h6>
                                <label for="si">Si</label>
                                <input class="antecedentes-input__input" type="checkbox" name="si">
                                <label for="no">No</label>
                                <input class="antecedentes-input__input" type="checkbox" name="no">
                            </div>
                    ...
                    <div class="entrevista-submit" id="btn-entrevista">
                        <input class="entrevista-submit__input" type="submit" value="Enviar Datos" @click="insertData">
                    </div>
            </form>
