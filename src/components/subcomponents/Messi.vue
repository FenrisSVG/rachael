<template>
    <section class="quesillo">
      <h2 class="quesillo-title">Sobre el Psicologo Leonel Messi</h2>
      <article class="article-quesillo">
          <header class="article-quesillo__header">
              ...
              <div class="quesillo-text">
                <h6 class="quesillo-text__title">Leonel Messi</h6>
                <p class="quesillo-text__info"><span>Idiomas:</span> Español, Ingles, Aleman.</p>
                <p class="quesillo-text__info"><span>Nacionalidad: </span> Argentino che boludo.</p>
                <p class="quesillo-text__info"><span>Modelo de Trabajo Terapeutico:</span> Sistemico.</p>
