  ...
  methods:{
   mostrar(){
      const sintomas = async()=>{
        const res = await axios.post('http://localhohost:8080/autoevaluacion/autoevaluacion.php',{opcion: 1})
        this.sintomas = res.data
     
        await axios.post('http://localhohost:8080/autoevaluacion/autoevaluacion.php',{opcion: 4})
        .then(res => {
    ...
    modalShow(){
      ...
      const getId = async()=>{
        try{
          const res = await axios.post('http://localhohost:8080/autoevaluacion/autoevaluacion.php',{
              opcion: 10,
      ...
      if(paranoia){
          if(paranoia.checked){
            ...
            axios.post('http://localhohost:8080/autoevaluacion/autoevaluacion.php',{
                opcion: 6,
                idtrastorno: 22
    ...
    obtenerFecha(){
      ...
      // if(login.innerHTML !== 'Login'){
        const response = async () =>{
          if(username){
            const res = await axios.post('http://localhohost:8080/autoevaluacion/autoevaluacion.php',{opcion: 10,
